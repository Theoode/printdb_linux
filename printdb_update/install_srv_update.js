...
const serviceFilePath = '/etc/systemd/system/printdb_update.service';
...
[Service]
ExecStart=/usr/bin/node /home/user/printdb_linux/printdb_update/update.js
WorkingDirectory=/home/user/printdb_linux/printdb_update
Restart=always
User=root          
Group=root           
